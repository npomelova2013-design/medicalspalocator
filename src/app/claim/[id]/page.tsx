  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <Link href={`/med-spa/${spa.url_slug}`} className="hover:text-teal-600">{spa.business_name}</Link>
        <span className="mx-2">/</span>
        <span className="text-gray-900">Claim</span>
      </nav>

      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Claim Your Listing</h1>

      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        <h3 className="font-semibold text-gray-900">{spa.business_name}</h3>
        <p className="text-sm text-gray-600">{spa.city}, {spa.state}</p>
