...
export function StatsBar({ totalSpas, totalCities }: Props) {
  return (
    <div className="relative bg-[#5C1A33] py-20 md:py-28 overflow-hidden">
      {/* Background orbs */}
      ...
      <div className="relative max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-evenly">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <span className="text-sm uppercase tracking-[0.2em] text-[#D4AF37]/60 mt-3">
              Med Spas
            </span>
          </div>

          {/* Separator */}
          <div className="hidden sm:block h-16 w-px bg-[#D4AF37]/20" />
