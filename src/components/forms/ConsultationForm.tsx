...
export function ConsultationForm({ medSpaId, medSpaCity }: Props) {
  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        ...
        <h4 className="font-serif font-semibold text-slate-900 text-lg mb-1">Request Submitted!</h4>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="service" className="text-xs font-medium text-slate-600">Service Interested In</label>
      ...
      <div>
        <label htmlFor="timeline" className="text-xs font-medium text-slate-600">Timeline</label>
      ...
      <div>
        <label htmlFor="message" className="text-xs font-medium text-slate-600">Message (optional)</label>
