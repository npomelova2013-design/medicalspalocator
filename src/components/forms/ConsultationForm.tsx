  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        <div className="w-14 h-14 bg-[#833AB4]/10 rounded-full flex items-center justify-center mx-auto mb-4">
          <CheckCircle2 className="w-8 h-8 text-[#833AB4]" />
        </div>
        <h4 className="font-serif font-semibold text-[#262626] text-lg mb-1">Request Submitted!</h4>
        <p className="text-sm text-[#262626]/50">We&apos;ll be in touch within 24 hours.</p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label htmlFor="firstName" className="text-xs font-medium text-[#262626]/60">First Name *</label>
          <input id="firstName" name="firstName" required placeholder="Jane" className={inputClass} />
        </div>
        <div>
          <label htmlFor="lastName" className="text-xs font-medium text-[#262626]/60">Last Name</label>
          <input id="lastName" name="lastName" placeholder="Doe" className={inputClass} />
        </div>
      </div>
      <div>
        <label htmlFor="phone" className="text-xs font-medium text-[#262626]/60">Phone *</label>
        <input id="phone" name="phone" type="tel" required placeholder="(555) 123-4567" className={inputClass} />
      </div>
      <div>
        <label htmlFor="email" className="text-xs font-medium text-[#262626]/60">Email</label>
        <input id="email" name="email" type="email" placeholder="jane@email.com" className={inputClass} />
      </div>
      <div>
        <label htmlFor="service" className="text-xs font-medium text-[#262626]/60">Service Interested In</label>
      ...
      <div>
        <label htmlFor="timeline" className="text-xs font-medium text-[#262626]/60">Timeline</label>
      ...
      <div>
        <label htmlFor="message" className="text-xs font-medium text-[#262626]/60">Message (optional)</label>
      ...
      <p className="text-[11px] text-[#262626]/30 text-center leading-relaxed">
